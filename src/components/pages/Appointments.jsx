...
const Appointments = () => {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      navigate("/signup"); // Redirect to signup  if no token found
      return;
    }
          ...
          >
            ...
            <div className="w-full md:w-3/4">
              ...
              <div className="flex justify-end">
                <button className="px-4 py-2 rounded-xl font-semibold text-white shadow-md transition-all duration-300 bg-[linear-gradient(90deg,_rgba(36,0,9,1)_0%,_rgba(121,9,13,1)_77%,_rgba(214,69,69,1)_94%)] hover:-translate-y-1  active:scale-95">
...
// px-4 py-2 rounded-xl font-semibold text-white shadow-md transition-all duration-300 bg-[linear-gradient(90deg,_rgba(36,0,9,1)_0%,_rgba(121,9,13,1)_77%,_rgba(214,69,69,1)_94%)] hover:-translate-y-1  active:scale-95