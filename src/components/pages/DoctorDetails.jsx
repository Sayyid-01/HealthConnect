      ...
      <div className="w-full md:w-2/3 bg-white p-6 rounded-lg shadow-md">
        ...
        {doctor.available ? (
          <>
            ...
            <div className="mt-8">
              <button
                className={`px-6 py-3 font-semibold rounded-full transition duration-300 ${selectedDateTime
                    ? "bpx-6 py-2 rounded-xl font-semibold text-white shadow-md transition-all duration-300 bg-[linear-gradient(90deg,_rgba(36,0,9,1)_0%,_rgba(121,9,13,1)_77%,_rgba(214,69,69,1)_94%)] hover:shadow-[0_0_20px_4px_rgba(214,69,69,0.5)]"
